...
})({"7mqoR":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 53645;
var HMR_SECURE = false;
var HMR_ENV_HASH = "439701173a9199ea";
var HMR_USE_SSE = false;
module.bundle.HMR_BUNDLE_ID = "31650656ba8423d0";
"use strict";
...
},{}],"4kLc5":[function(require,module,exports,__globalThis) {
async function getWeather() {
    ...
    try {
        const response = await fetch(`http://api.openweathermap.org/data/2.5/weather?zip=${location},us&units=imperial&appid=${apiKey}`);
        if (!response.ok) throw new Error("No weather found...");
        const weatherInfo = await response.json();
        console.log(weatherInfo);
        document.getElementById('output').innerText = `In ${weatherInfo.name}, it is ${Math.floor(weatherInfo.main.temp)}\xb0F with ${weatherInfo.weather[0].description}.`;
    } catch (error) {
...
},{}]},["7mqoR","4kLc5"], "4kLc5", "parcelRequire5958", {})
